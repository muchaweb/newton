...
<head>
	...
	<link href="catalog/view/theme/newton/stylesheet/stylesheet.css" rel="stylesheet">
		...
		<nav id="navigation" role="navigation">
			...
			<div class="nav-site">
				<div class="nav-site__logo">
					<?php if ($logo) { ?>
					<h1 class="primary-logo sr-only"><?php echo $name; ?></h1>
					<a href="<?php echo $home; ?>" class="primary-logo_link" title="<?php echo $name.' Home'; ?>">
						<img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" class="primary-logo_img" />
					</a>
					<?php } ?>
				</div>
				<div class="nav-site__search">
					<?php echo $search; ?>
				</div>
				<div class="nav-site__categories">

					<ul class="menu">
						<?php foreach ($categories as $category) { ?>
						<?php if ($category['children']) { ?>
						<li class="menu__item">
							<a href="<?php echo $category['href']; ?>" class="menu__link"><?php echo $category['name']; ?></a>
							<div class="menu__sub-level">
								<div class="menu__sub-level__inner">
									<div class="menu__sub-level__wrapper">
										<?php foreach (array_chunk($category['children'], ceil(count($category['children']) / $category['column'])) as $children) { ?>
										<ul class="menu__list">
											<?php foreach ($children as $child) { ?>
											<li class="menu__list__item">
												<a href="<?php echo $child['href']; ?>" class="menu__list__link"><?php echo $child['name']; ?></a>
												</li>
											<?php } ?>
										</ul>
										<?php } ?>
						...
						<?php } else { ?>
						<li class="menu__item">
							<a href="<?php echo $category['href']; ?>" class="menu__link"><?php echo $category['name']; ?></a></li>
						<?php } ?>
						<?php } ?>
					</ul>
				</div>
