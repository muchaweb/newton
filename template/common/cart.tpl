<div class="o-mini-cart">
  <a href="<?php echo $cart; ?>"
     ...
     class="o-mini-cart__link" >
    <span class="o-mini-cart__label">
      <i class="fa fa-shopping-cart"></i>
      <span class="o-mini-cart__label"><?php echo $text_shopping_cart; ?></span>
    </span>
    <span class="o-mini-cart__count">
      <?php echo $text_items; ?>
    </span>
  </a>
  <div class="o-mini-cart__content">
